...
![preview](https://pic4.zhimg.com/v2-148d2678cb70ba3a0400bb08891cb2af_r.jpg)
...
（上面的/dev/centos/root不能随便改成centos-root。LVM逻辑卷管理，根文件系统建立在卷组（VG）centos上的逻辑卷（LV）上，逻辑卷名是root而不是直接建在硬盘分区上
